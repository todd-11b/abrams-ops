...
const TABLES: Record<string, { read: string[]; write: string[]; filters: string[] }> = {
  jobs: { read: ['job_id','job_number','contact_id','proposal_id','sales_opportunity_id','production_opportunity_id','opportunity_contract','stage','status','install_date','scheduled_start_window','deposit_status','deposit_paid_at','signed_at','final_payment_status','final_payment_paid_at','blocked_reason','blocked_note','blocked_at','needs_review_reason','access_notes','last_activity_at','last_activity_by','completed_at','archived_at','last_ghl_sync','ghl_stage','last_blocked_notification_at','created_at'], write: ['stage','status','blocked_reason','blocked_note','blocked_at','last_activity_at','last_blocked_notification_at'], filters: ['job_id','archived_at','deposit_status'] },
